...
df.deduped <- df %>%
  group_by(cand_id, cand_name, pty_cd, incumbent, won, ttl_disb) %>%
...
Figure \@ref(fig:revisited-histogram) reproduces the histogram from \@ref(fig:preliminary-histogram) using the refined dataset.  The asymmetric mass on the left hand side of the histogram is no longer present.  The histogram appears to be much more symetric.  However, we now appear to have a few candidates receiving more than 100% of the vote in their races...
